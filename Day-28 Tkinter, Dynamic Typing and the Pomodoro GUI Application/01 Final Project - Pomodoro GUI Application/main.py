...
tomato_img = PhotoImage(file="D:/PYTHON-PRACTICE/02-PYTHON-BOOTCAMP/28_Tkinter,_Dynamic_Typing_and_the_Pomodoro_GUI_Application/code/Pomodoro Timer Project Tkinter/tomato.png")
